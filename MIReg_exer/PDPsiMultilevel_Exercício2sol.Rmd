...
DF_POPULAR <- read.spss("G:\\My Drive\\FPCEUP\\AtividadeDocente\\MultilevelReg\\MLReg_data\\popular.sav", to.data.frame = TRUE)

DF_POPULAR <-
  read.csv2(
    "G:\\My Drive\\FPCEUP\\AtividadeDocente\\MultilevelReg\\MLReg_data\\popular.csv",
