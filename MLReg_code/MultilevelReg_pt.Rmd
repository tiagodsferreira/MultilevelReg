---
title: "Data Management and Exploratory Data Analysis in R"
author: "Patrício Costa & Tiago Ferreira"
output:
...
```{r}
SchoolsData <- read.csv("I:\\My Drive\\FPCEUP\\AtividadeDocente\\MultilevelReg\\MLReg_data\\SchoolsData.csv")
...
knitr::include_graphics("I:\\My Drive\\FPCEUP\\AtividadeDocente\\MultilevelReg\\figures\\1_singlelevel.JPG")
...
knitr::include_graphics("I:\\My Drive\\FPCEUP\\AtividadeDocente\\MultilevelReg\\figures\\nullmodel.JPG")
```
...
```{r, out.width = "500px", echo = FALSE}
knitr::include_graphics("I:\\My Drive\\FPCEUP\\AtividadeDocente\\MultilevelReg\\figures\\2_randointercept.JPG")
```
...
$$y_{ij} = \gamma_{00} + \gamma_{10}x_{ij} + U_{0j} + U_{1j}x_{ij} + \varepsilon_{ij}$$
```{r, out.width = "500px", echo = FALSE}
knitr::include_graphics("I:\\My Drive\\FPCEUP\\AtividadeDocente\\MultilevelReg\\figures\\3_randointerceptslope.JPG")
```
...
knitr::include_graphics("I:\\My Drive\\FPCEUP\\AtividadeDocente\\MultilevelReg\\figures\\Multilevel_Hox.jpg")
```
